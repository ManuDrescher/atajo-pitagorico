...
if(stepDemo===7){
add("7️. Como hay cuatro triángulos: \\(4 \\times \\frac{c_1 c_2}{2}\\).");
}

if(stepDemo===8){
add("8. Entonces el área total también puede escribirse como: <br> \\((c_1+c_2)^2 = 4\\frac{c_1c_2}{2} + h^2\\)");
}

if(stepDemo===9){
add("9. Expandimos el cuadrado: <br> \\(c_1^2 + 2c_1c_2 + c_2^2\\)");
}

if(stepDemo===10){
add("10. Cancelamos los términos iguales: <br> \\(c_1^2 + \\cancel{2c_1c_2} + c_2^2 = \\cancel{2c_1c_2} + h^2\\)");
}

if(stepDemo===11){
add("11. Obtenemos el resultado: <br> \\(c_1^2 + c_2^2 = h^2\\)");
}

if(stepDemo===12){
add("Aplicamos al problema: <br> \\(36^2 + 48^2 = 3600\\) <br> \\(h = 60\\). 🐺 El lobo recorrió solo 60 pasos.");
}
